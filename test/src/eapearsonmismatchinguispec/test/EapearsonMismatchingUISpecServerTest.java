package eapearsonmismatchinguispec.test;
...
import eapearsonmismatchinguispec.EapearsonMismatchingUISpecServer;
...
public class EapearsonMismatchingUISpecServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static EapearsonMismatchingUISpecServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("eapearson_MismatchingUISpec");
        ...
        impl = new EapearsonMismatchingUISpecServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_EapearsonMismatchingUISpec_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("eapearson_MismatchingUISpec").withMethod("please_never_use_it_in_production")
