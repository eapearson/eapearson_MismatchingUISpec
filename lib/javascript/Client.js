...
function eapearson_MismatchingUISpec(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.example_method = function (ws, p, _callback, _errorCallback) {
        if (typeof ws === 'function')
            throw 'Argument ws can not be a function';
        ...
        return json_call_ajax(_url, "eapearson_MismatchingUISpec.example_method",
            [ws, p], 0, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_MismatchingUISpec.status",
