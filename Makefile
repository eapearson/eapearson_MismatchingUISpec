SERVICE = eapearson_mismatchinguispec
SERVICE_CAPS = eapearson_MismatchingUISpec
SPEC_FILE = eapearson_MismatchingUISpec.spec
URL = https://kbase.us/services/eapearson_mismatchinguispec
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
